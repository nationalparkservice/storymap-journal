  ...
  storyHTML += '</button>';
	...
	function exportNarrative(content)
	{
		...
		content.find('iframe').each(function() {
			...
			if (videoIDYouTube) {
				node.replaceWith('<div class="media media-image"><img alt="" src="http://img.youtube.com/vi/' + videoIDYouTube + '/0.jpg" /></div><i class="media-video-warning">' + strings.printVideoWarning + '</i>');
			}
